...
export const STOCKS: StockInfo[] = [
  ...
  },
  {
    ...
    region: "국내장",
    grade: "소형주",
    themes: ["메모리반도체", "DRAM/SRAM", "AI메모리 수혜주", "소형주 테마"],
    currentPrice: 43750,
    currency: "KRW",
    description: "국내 유일 DRAM·SRAM 메모리 설계 코스닥 소형주. AI·HBM 메모리 수요 확대 수혜주. 삼성·SK하이닉스 파운드리 위탁 생산 구조.",
    splitEntries: [
      { ratio: 30, dropPercent: 8,  targetPrice: Math.round(43750 * 0.92) },
      { ratio: 30, dropPercent: 15, targetPrice: Math.round(43750 * 0.85) },
      { ratio: 40, dropPercent: 25, targetPrice: Math.round(43750 * 0.75) },
    ],
    profitTargets: [
      { percent: 5,  price: Math.round(43750 * 1.05) },
      { percent: 10, price: Math.round(43750 * 1.10) },
      { percent: 20, price: Math.round(43750 * 1.20) },
    ],
    boxRange: {
      support: 30000,
      resistance: 72000,
    ...
    forecasts: [
      { period: "1일 후",    price: 44300,  changePercent: 1.3  },
      { period: "1주 후",    price: 46600,  changePercent: 6.5  },
      { period: "1개월 후",  price: 50800,  changePercent: 16.1 },
      { period: "3개월 후",  price: 56400,  changePercent: 28.9 },
      { period: "6개월 후",  price: 65000,  changePercent: 48.6 },
      { period: "12개월 후", price: 80000,  changePercent: 82.9 },
      { period: "1800일",   price: 220000, changePercent: 402.3 },
    ],
    financials: {
      per: 18.5,
      pbr: 2.1,
      ...
      revenueGrowth: 22.8,
      evaluation: "적정",
      summary: "메모리 설계 전문 코스닥 소형주. AI·HBM 수요 확대 수혜 기대. 소형주 특성상 변동성 높으나 독자 기술력 보유.",
    },
    dayFeatures: [
      { day: "월요일", feature: "반도체 섹터 동반 등락",       caution: "삼성·SK하이닉스 뉴스 연동 급변" },
      { day: "화요일", feature: "소형주 투기적 매수 유입",     caution: "변동성 매우 높음" },
      { day: "수요일", feature: "숨고르기·기술적 조정",        caution: "추세 확인 필요" },
      { day: "목요일", feature: "실적·수주 발표 연동 급등락",  caution: "급등 후 차익실현 압박" },
      { day: "금요일", feature: "소형주 오후 약세 경향",       caution: "주말 포지션 정리 물량 주의" },
    ],
    risk: {
      geopolitical: "미중 반도체 갈등·수출 규제 직접 영향. 글로벌 메모리 수급 사이클에 민감.",
      technicalBounce: "RSI 25 이하 극단적 과매도 시 단기 반등 기대. 30,000원 강한 지지선.",
      strategy: "전체 포트의 5% 이하 배분. 메모리 업황 호조 시 단기 트레이딩. 모멘텀 소멸 시 즉시 청산.",
    },
    witchDayStrategy: "코스닥 소형주로 만기일 영향 제한적. 시장 전반 변동 시 급락 취약. 만기일 전날 포지션 축소 권장.",
    entryRecommendation: "8% 하락(₩40,250) 1차 진입 적절. 메모리 반도체 업황 사이클 확인 후 단기 매매 전략 유효.",
  },
];
