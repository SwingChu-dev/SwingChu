...
export const STOCKS: StockInfo[] = [
  ...
  },
  {
    ...
    splitEntries: [
      { ratio: 30, dropPercent: 8,  targetPrice: Math.round(6200 * 0.92) },
      { ratio: 30, dropPercent: 15, targetPrice: Math.round(6200 * 0.85) },
      { ratio: 40, dropPercent: 25, targetPrice: Math.round(6200 * 0.75) },
    ],
    profitTargets: [
      { percent: 5,  price: Math.round(6200 * 1.05) },
      { percent: 10, price: Math.round(6200 * 1.10) },
      { percent: 20, price: Math.round(6200 * 1.20) },
    ],
    boxRange: {
      support: 4500,
      resistance: 9000,
    ...
    forecasts: [
      { period: "1일 후",    price: 6280,  changePercent: 1.3  },
      { period: "1주 후",    price: 6600,  changePercent: 6.5  },
      { period: "1개월 후",  price: 7200,  changePercent: 16.1 },
      { period: "3개월 후",  price: 8000,  changePercent: 29.0 },
      { period: "6개월 후",  price: 9500,  changePercent: 53.2 },
      { period: "12개월 후", price: 12000, changePercent: 93.5 },
      { period: "1800일",   price: 35000, changePercent: 464.5 },
    ],
    financials: {
      per: 18.5,
      pbr: 2.1,
    ...
    risk: {
      ...
      technicalBounce: "RSI 25 이하 극단적 과매도 시 단기 반등 기대. 4,500원 강한 지지선.",
    ...
    entryRecommendation: "8% 하락(₩5,704) 1차 진입 적절. 메모리 반도체 업황 사이클 확인 후 단기 매매 전략 유효.",
  },
];
